...
class Journal:
    ...
    def get_best_node(self, only_good=True, use_val_metric_only=False, cfg=None) -> None | Node:
        ...
        try:
            if cfg is None or cfg.agent.get("select_node", None) is None:
                model = os.environ.get("AISC_DEFAULT_SUMMARY_MODEL", "gpt-4o")
                temperature = 0.3
            else:
    ...
    def generate_summary(self, include_code: bool = False, **model_kwargs) -> str:
        ...
        summary = query(
            ...
            model=model_kwargs.get("model", os.environ.get("AISC_DEFAULT_SUMMARY_MODEL", "gpt-4o")),
    ...
    def save_experiment_notes(self, workspace_dir: str, stage_name: str, cfg: Any) -> None:
        ...
        stage_summary = query(
            ...
            model=cfg.agent.summary.model if cfg.agent.get("summary", None) else os.environ.get("AISC_DEFAULT_SUMMARY_MODEL", "gpt-4o"),
